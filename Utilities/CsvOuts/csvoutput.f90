...
Subroutine CsvOutSumOpsum(RUN, TRTNUM, ROTNO, ROTOPT, REPNO, CROP, MODEL, &
   ...
   CWAM, HWAM, HWAH, BWAH, EYLDH, PWAM, HWUM, HNUMUM, HIAM, LAIX, HNUMAM, &
...
!  Recalculated vars
   Integer :: cHWAH1, cBWAH1, cHWAHF1, cFBWAH1, cEYLDH
   ...
   CWAM, HWAM, cHWAH1, cBWAH1, cEYLDH, PWAM, HWUM, HNUMAM, HNUMUM, HIAM, LAIX, &
